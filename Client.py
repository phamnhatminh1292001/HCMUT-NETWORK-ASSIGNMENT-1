...
class Client:
        ...
        def setupMovie(self):
                ...
                if self.state == self.INIT:
                        ...
                        print("press PLAY to play video"+"\n Press PAUSE to pause video and view time information"+"\n Press TEARDOWN to exit video")
        ...
        def exitClient(self):
                ...
                if self.sumOfTime>0:
                        ...
                        print("\nVideo Data Rate: " + str(round(rateData,2)) +"\n")
        ...
        def listenRtp(self):            
                ...
                while True:
                        try:
                                ...
                                self.sumOfTime += time.time() - self.begin
                                self.stop = True
                                # Stop listening upon requesting PAUSE or TEARDOWN and print time information
                                if self.playEvent.isSet():
                                        print('Current Time: ')
                                        self.currtime=round(time.time()-start,2)
                                        print(str(self.currtime))
                                        remainingtime=round(self.totaltime-self.currtime,2)
